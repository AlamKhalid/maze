...
/*
 *	get_t_node_middle
 *	Get function for "middle" field.
 *	Pre-condition: none
 *	Post-condition: the t_node variable's middle field is
 *					returned
 *	Informally: examine the t_node variable's "middle"
 *				field returning its value
 *
 *	return t_node the middle branch of the current node
 */
